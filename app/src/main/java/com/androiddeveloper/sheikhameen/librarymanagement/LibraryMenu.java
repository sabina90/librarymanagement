    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newAccount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(),
                        com.androiddeveloper.sheikhameen.librarymanagement.register.class);
        ...
        addBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(getApplicationContext(),
                        com.androiddeveloper.sheikhameen.librarymanagement.AddBook.class);
                startActivity(intent);
        ...
        Stats.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent intent=new Intent(getApplicationContext(),
                            com.androiddeveloper.sheikhameen.librarymanagement.Books_stats_menu.class);
                    startActivity(intent);
                }
        ...
        issueBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(),
                        com.androiddeveloper.sheikhameen.librarymanagement.IssueBook.class);
                startActivity(intent);
        ...
        returnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(),
                        com.androiddeveloper.sheikhameen.librarymanagement.ReturnBook.class);
                startActivity(intent);
            }
        });
